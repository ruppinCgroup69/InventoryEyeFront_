...
export default function BonusDetailsModal({ visible, onClose, onDelete, bonus,categories }) {
      ...
      <View style={styles.modalOverlay}>
        <View style={styles.modalContainer}>
          ...
          <View style={styles.buttonContainer}>
            ...
            <TouchableOpacity onPress={() => onDelete(bonus.bonusId)} style={styles.closeButton}>
